    ...
    datasets: [
      {
        label: "# of Votes",
        data: [55, 30, 15],
        backgroundColor: ["blue", "#1cc88a", "skyblue"],
        borderColor: ["blue", "#1cc88a", "skyblue"],
        borderWidth: 1,
      },
    ],
  };
    ...
    <div className="box2">
      <div className="earnings_overview">
        <div className="earnings_overview_tittle">
          <h3 className="earnings_overview_heading">Earnings Overview</h3>
          <IconButton
      ...
      <div className="revenue_sources">
        <div className="revenue_sources-tittle">
          <h3 className="revenue_heading">Revenue Sources</h3>
          <IconButton
            aria-controls={open ? "basic-menu" : undefined}
            aria-haspopup="true"
            aria-expanded={open ? "true" : undefined}
